...
/**
 * Liest die Client-Authentifizierung des Public Clients (nur {@code client_id}) am
 * Device-Authorization- und Token-Endpoint. Vorlage: Spring Authorization Server Sample.
 */
